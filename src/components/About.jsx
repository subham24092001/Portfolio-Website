  ...
  return (
    ...
    >
      <div className="max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full">
        <div className="pb-8">
          <p className="text-4xl font-bold inline border-b-4 border-gray-500">About Me and Experience</p>
        </div>
        ...
        <p className="text-xl">
          ...
          <br /><br />
          I have created some projects using these technologies like Ecommerce Website, FileSharing website, ChatApp, Portfolio website, Blog Website, Music App.
        </p>
      </div>
    </div>
  );
